...
// W25C-fix: el label visible (<span>{labelForTool(id)}</span> en el boton
// que envuelve este icono) ya es el nombre accesible del boton. Antes el
// icono TAMBIEN aportaba nombre accesible (role="img" + aria-label + un
// <title> interno), asi que el nombre accesible del boton terminaba siendo
// la suma de ambos ("PasePase", medido en vivo). Con el label siempre
// visible (W25C parte 1), el icono pasa a ser puramente decorativo:
// aria-hidden lo saca del calculo de nombre accesible por completo, dejando
// UNA sola fuente (el texto visible).
